  ...
  return (
    <div className='flex items-center justify-center py-16'>
      <div className='border-t border-gray-300 py-10'>
        <div className='items-center px-5 py-7 border border-gray-300'>
          <div className='py-2 font-extrabold text-[18px]'>
            📢 가짜 은행사이트에 속지 마세요!!
          </div>
          <div className='pl-7 py-2 font-semibold text-blue-400 text-[15px]'>
